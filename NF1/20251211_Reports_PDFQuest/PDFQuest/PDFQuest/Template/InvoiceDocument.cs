    ...
    public class InvoiceDocument : IDocument
    {
        ...
        void ComposeContent(IContainer container)
        {
            container.PaddingVertical(40).Column(column =>
            {
                ...
                column.Item().Text($"Total amount:{Model.GetTotalAmount()}$").AlignEnd().FontSize(15).Bold();
        ...
        void ComposeTable(IContainer container)
        {
            container.Table(table =>
            {
                ...
                table.Header(header =>
                {
                    ...
                    header.Cell().Element(CellStyle).Background(Colors.Grey.Lighten3).Padding(2).Column(column =>
                     {
                         column.Spacing(1);
                    ...
                    {
                        return container.DefaultTextStyle(x => x.SemiBold()).PaddingVertical(0).Border(1).BorderColor(Colors.Black);
                    }
                });
