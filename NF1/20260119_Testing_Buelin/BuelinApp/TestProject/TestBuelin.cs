...
namespace TestProject
{
    ...
    public sealed class TestBuelin
    {
        ...
        public void TestBuelinGetPreu_Erronis()
        {
            ...
            Assert.Throws<Exception>(() => { b.getSobrecostPerEquipatge([10, 10, 10],       -12, null, false); });
            Assert.Throws<Exception>(() => { b.getSobrecostPerEquipatge([10, 10, 10],       0, null, false); });
        ...
        public void TestBuelinGetPreu()
        {
            ...
            Assert.AreEqual(0m, b.getSobrecostPerEquipatge(null, null, [20, 20], false));
            Assert.AreEqual(20m, b.getSobrecostPerEquipatge(null, null, [20, 21], false));
            Assert.AreEqual(200m, b.getSobrecostPerEquipatge(null, null, [20, 20, 20], false));
            Assert.AreEqual(220m, b.getSobrecostPerEquipatge(null, null, [20, 21, 20], false));
